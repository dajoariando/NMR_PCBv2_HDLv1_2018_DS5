...
void cpmg_param_calculator_ltc2314(unsigned int * output,// cpmg parameter output
...
void cpmg_param_calculator_ltc1746(unsigned int * output,// cpmg parameter output
